...
function Banner() {
  ...
  return (
    <div className="w-full h-[30vh] 2xl:h-[55vh] 3xl:h-[30vh] grid grid-cols-4 2xl:grid-cols-5 3xl:grid-cols-4 relative bg-banner bg-cover shadow-xl border-b-2 border-sky-400">
