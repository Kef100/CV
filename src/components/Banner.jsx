...
function Banner() {
  ...
  return (
    <div className="w-full h-[55vh] 3xl:h-[30vh] grid grid-cols-4 2xl:grid-cols-5 3xl:grid-cols-4 relative bg-banner bg-cover shadow-xl border-b-2 border-sky-400">
      <div className="col-span-4 lg:col-span-4 xl:col-span-2 2xl:col-span-3 3xl:col-span-2 z-20 py-14 px-6 xl:px-10 xl:py-10">
