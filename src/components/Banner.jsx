...
function Banner() {
  ...
  return (
    <div className="w-full h-[50vh] 3xl:h-[30vh] grid grid-cols-4 3xl:grid-cols-4 relative bg-banner bg-cover shadow-xl border-b-2 border-sky-400">
      <div className="col-span-4 lg:col-span-4 xl:col-span-2 z-20 py-14 px-6 xl:px-10 xl:py-10">
