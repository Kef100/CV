...
function Banner() {
  return (
    <div className="w-full h-[50vh] xl:h-[25vh] grid grid-cols-4 relative bg-banner bg-cover shadow-xl border-b-2 border-sky-400">
      ...
      <div className="z-20">
        <img src="https://bslthemes.com/arter/wp-content/uploads/2020/09/face-2-min.png" className="absolute bottom-0 right-12 h-[27vh]" alt="me standing" />
      </div>
