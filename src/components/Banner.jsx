...
function Banner() {
  ...
  return (
    <div className="w-full h-[50vh] 3xl:h-[30vh] grid grid-cols-4 2xl:grid-cols-5 3xl:grid-cols-4 relative bg-banner bg-cover shadow-xl border-b-2 border-sky-400">
      ...
      <div className="z-20 hidden xl:block 2xl:col-span-2 3xl:col-span-1 relative">
