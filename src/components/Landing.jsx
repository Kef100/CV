...
function Landing() {
  ...
  return (
    <div className="w-full h-screen flex flex-col gap-y-5 p-6 px-20 lg:px-32 bg-gray-200 dark:bg-neutral-900 transition-all">
      <div className="rounded-2xl bg-accent-300 bg-landing bg-cover w-full h-full relative overflow-hidden shadow-xl">
        ...
        <img src="./plane.png" alt="plane" className="absolute w-32 top-20 -right-32 animate-fly" />
        <img src="./plane.png" alt="plane" className="absolute w-32 top-40 image-flip -left-32 animate-fly-reverse" />
